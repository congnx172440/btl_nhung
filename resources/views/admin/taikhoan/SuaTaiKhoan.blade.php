...
@section('content')
    <div class="col-sm-4">
        <a href="admin/taikhoan/danhsach/{{$taikhoan->id_cong_ty}}">
    ...
    <form class="user" action="admin/taikhoan/sua/{{$taikhoan->id}}" method="post" enctype="multipart/form-data">
        <hr />
        ...
        <a href="admin/taikhoan/chontbsua/{{$taikhoan->id}}">
