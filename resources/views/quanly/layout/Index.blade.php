...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="quanly/thongtin/{{Auth::user()->id}}">
            ...
            <!-- Nav Item - Quản lý tài khoản Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="quanly/taikhoan/danhsach/{{Auth::user()->id_cong_ty}}"  >
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Quản lý tài khoản</span>
                </a>
            </li>

            <!-- Nav Item - Quản lý chấm công công ty -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="quanly/chamcong/chon/{{Auth::user()->id_cong_ty}}" >
                    <i class="fa fa-list-alt"></i>
                    <span> Quản lý chấm công công ty</span>
                </a>
            </li>

            <!-- Nav Item - Quản lý chấm công nhân viên -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="quanly/chamcong/chonnv/{{Auth::user()->id_cong_ty}}" >
                    <i class="fa fa-users"></i>
                    <span> Quản lý chấm công nhân viên</span>
                </a>
            </li>

            <!-- Nav Item - Quản lý chấm công nhân viên -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="quanly/chamcong/them/{{Auth::user()->id_cong_ty}}" >
                      ...
                      <!-- Nav Item - User Information -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="quanly/thongtin/{{Auth::user()->id}}">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Thông tin
                                </a>
                                <a class="dropdown-item" href="quanly/taikhoan/sua/{{Auth::user()->id}}">
